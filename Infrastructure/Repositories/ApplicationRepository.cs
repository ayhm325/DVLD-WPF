...
public class ApplicationRepository : IApplicationRepository
{
    ...
    public async Task<List<ApplicationD>> GetApplicationsByStatusAsync(AppStatus status)
    {
    ...
    public async Task<int?> HasDuplicateApplicationAsync(int personId, int licenseClassId)
    {
        ...
        var applicationId = await _context.LocalDrivingLicenseApplications
            .AsNoTracking()
            .Where(ldla =>
                ldla.Application.ApplicantPersonID == personId &&
                ldla.LicenseClassID == licenseClassId &&
                (ldla.Application.ApplicationStatus == AppStatus.New ||
                 ldla.Application.ApplicationStatus == AppStatus.Completed))
    ...
    public async Task AddNewApplicationAsync(ApplicationD application)
    {
